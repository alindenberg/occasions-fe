...
export default function SignupPage() {
    ...
    return (
        <>
            <Head>
                <title>Sign Up | Occasion Alerts</title>
                <meta name="description" content="Create an account with Occasion Alerts" />
            </Head>
            ...
            <div className="min-h-screen bg-gray-50 flex flex-col w-full">
                ...
                {/* Signup Form - with more space from header */}
                    ...
                    <div className="w-full sm:w-96">
                        <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-100">
                            <div className="px-6 pt-6 pb-4">
                                ...
                                <p className="text-gray-600 text-center mb-4">Enter your information to get started</p>
                            ...
                            <div className="px-6 py-3 bg-gray-50 border-t border-gray-200 text-center">
                                <p className="text-sm text-gray-600">
                                    Already have an account? <Link href="/login" className="font-medium text-orange-500 hover:text-orange-600">Log in now</Link>
                                </p>
                            </div>
                        </div>
                    </div>
