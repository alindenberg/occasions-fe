...
export default function Sidebar({
    ...
    return (
        <>
            ...
            {/* Sidebar for desktop */}
            <aside
                className={`bg-white border-r border-gray-200 h-screen fixed top-0 left-0 pt-20 transition-all duration-300 z-50
            ...
            <aside
                id="mobile-sidebar"
                className={`md:hidden bg-white border-r border-gray-200 h-screen fixed top-0 left-0 pt-20 w-64 z-50 transform transition-transform duration-300 ease-in-out ${isMobileOpen ? 'translate-x-0' : '-translate-x-full'
                    }`}
            >
                <div className="flex flex-col h-full">
                    <div className="px-4 py-6">
